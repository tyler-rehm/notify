...
<head>
    ...
    <!-- CSS Page Style -->
    <link rel="stylesheet" href="/vendor/unify/assets/css/pages/page_404_error1.css">
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="error-v2">
                ...
                <p>The requested URL was not found on this server. <br> That’s all we know. Go back <a href="/">home</a>.</p>
            </div>
        </div>
    </div>
    <!--End Error Block-->
...
<script type="text/javascript" src="/vendor/unify/assets/js/plugins/style-switcher.js"></script>
...
<script type="text/javascript">
    $.backstretch([
        ...
        "/vendor/unify/assets/img/bg/8.jpg",
    ], {
        fade: 1000,
        duration: 7000
    });
